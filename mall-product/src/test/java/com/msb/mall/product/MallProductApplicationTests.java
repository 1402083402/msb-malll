...
public class MallProductApplicationTests {
    ...
    @Test
    public void test2(){
        List<SpuItemGroupAttrVo> attrgroupWithSpuId = attrGroupService.getAttrgroupWithSpuId(12l, 225l);
    ...
    @Test
    public void test3(){
        List<SkuItemSaleAttrVo> skuSaleAttrValueBySpuId = skuSaleAttrValueService.getSkuSaleAttrValueBySpuId(12l);
